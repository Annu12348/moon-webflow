...
useEffect(() => {
  if (loadRef1.current && loadRef2.current && loadLogoRef2.current) {
    ...
    // Then, animate loadRef1 and loadRef2 together
    tl.to(
      [loadRef1.current, loadRef2.current],
      {
        ...
        delay: 0.5,
        ease: "power3.inOut",
        stagger: 0, // both at the same time
      },
...
//if(!loading) return null;
  return (
    <div className=" w-full h-screen  bg-amber-400 absolute overflow-hidden ">
      <div ref={loadRef1} className="w-full h-[50%] bg-[#BE5A49] flex items-end justify-center overflow-hidden ">
        <img
        ref={loadLogoRef2}
          className=" h-7  "
